summon skeleton ^ ^ ^2 {Tags:["titan_skeleton", "big_titan_skeleton"],DeathLootTable:"minecraft:nothing",Silent:1,NoAI:1,ArmorItems:[{},{},{},{}]}
...
execute as @e[tag=titan_skeleton,limit=1,distance=..5,sort=nearest] run resource set @s phantom:shifter/is_colossal_skeleton 1
...
execute as @e[tag=titan_skeleton,limit=1,distance=..5,sort=nearest] run scale set pehkui:width 30
execute as @e[tag=titan_skeleton,limit=1,distance=..5,sort=nearest] run scale set pehkui:height 30
